...
@section('title','OBS - Active Customer')
                                                ...
                                                @foreach ($userList as $key => $user)
                                                    <tr class="odd" role="row">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="javascript:void(0);" class="btn btn-sm btn-blue" onclick="return getUserDetailsbyUserId({{ $user->id }})" title="Details">দেখুন </a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
