...
@section('title', ''.($global_setting->title ?? "").' | অফিসের লিস্ট')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">অফিসের লিস্ট</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('admin.index')}}">ড্যাশবোর্ড</a></li>
                            <li class="breadcrumb-item active">অফিসের লিস্ট</li>
                        </ol>
                    </div>
            ...
            <div class="col-xxl-12">
                ...
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">অফিসের লিস্ট</h4>
                                                            ...
                                                            <form action="{{route('admin.office.update', $office->id)}}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row g-3">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <select name="division" class="form-control division_id_{{$office->id}}" onchange="changes_division(this,{{$office->id}})" id="division" required>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <select name="district" onchange="changes_district(this,{{$office->id}})" class="form-control district_id_{{$office->id}}" id="district">
                                                                            {{-- <option value="{{$office->district_id}}">{{$office->district ? $office->district->name : '-'}}</option> --}}
                                                                            <option value="">--জেলা নির্বাচন করুন--</option>
                                                                            @php
                                                                                $editDistrict = App\Models\District::where('division_id', ($office->division_id ?? 0))->get();
                                                                            @endphp
                                                                            @foreach ($editDistrict as $district)
                                                                                <option @if($district->id == $office->district_id) selected @endif value="{{$district->id}}">{{$district->name}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div><!--end col-->
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <select name="upazila" class="form-control upazila_id_{{$office->id}}" id="upazila" >
                                                                            {{-- <option value="{{$office->upazila_id}}">{{$office->upazila ? $office->upazila->name : '-'}}</option> --}}
                                                                            <option value="">--উপজেলা নির্বাচন করুন--</option>
                                                                            @php
                                                                                $editUpazila = App\Models\Upazila::where('district_id', $office->district_id)->get();
                                                                            @endphp
                                                                            @foreach ($editUpazila as $upazila)
                                                                                <option @if($upazila->id == $office->upazila_id) selected @endif value="{{$upazila->id}}">{{$upazila->name}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div><!--end col-->
                                                                    ...
                                                                    <div class="col-lg-12 display_option{{$office->id}} @if($office->horticulture_center_id < 1) d-none @endif">
                                                                        <label for="horticulture" class="form-label">হর্টিকালচার<span style="color:red;">*</span></label>
            ...
            <div class="modal-body">
                <form action="{{route('admin.office.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <label for="division" class="form-label">অঞ্চল<span style="color:red;">*</span></label>
                            <select name="division" onchange="changes_division(this,0)" class="form-control division_id_0" id="division" required>
                        ...
                        <div class="col-lg-12">
                            <label for="district" class="form-label">জেলা</label>
                            <select name="district" onchange="changes_district(this,0)" class="form-control district_id_0" id="district">
                                <option value="">--জেলা নির্বাচন করুন--</option>
                        ...
                        <div class="col-lg-12">
                            <label for="upazila" class="form-label">উপজেলা</label>
                            <select name="upazila" class="form-control upazila_id_0" id="upazila">
                                <option value="">--উপজেলা নির্বাচন করুন--</option>
