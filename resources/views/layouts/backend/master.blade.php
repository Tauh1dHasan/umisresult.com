...
<head>
    ...
    <link href="{{ asset('public/admin-assets/assets/css/select2.min.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('public/admin-assets/assets/css/custom.css') }}" rel="stylesheet" type="text/css">
    @stack('styles')
    <!-- App css -->
...
<script src="{{ asset('public/admin-assets/assets/js/select2.min.js') }}"></script>
